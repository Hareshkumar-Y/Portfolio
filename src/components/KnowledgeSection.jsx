...
const LotusLogo = ({ className }) => (
  <svg className={className} viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M24 12C19 18 16 24 16 29C20 28 22 24 24 20C26 24 28 28 32 29C32 24 29 18 24 12Z" fill="white" />
    <path d="M24 20C20 16 18 12 18 12C22 14 24 18 24 20Z" fill="white" opacity="0.9" />
  </svg>
);
...
const software = [
  ...
  { name: 'Ansys', logo: <SiAnsys /> },
  { name: 'CATIA V5', logo: <SiDassaultsystemes /> },
  { name: 'Lotus Simulation', logo: <LotusLogo /> },
  { name: 'TinkerCad', logo: <SiTinkercad /> },
  { name: 'PCB design', logo: <SiAltiumdesigner /> },
  { name: 'STmicrocontrollers', logo: <SiStmicroelectronics /> },
  { name: 'ROS2', logo: <SiRos /> },
  { name: 'Embedded C/C++', logo: <SiCplusplus /> },
];
  ...
  return (
    <section id="knowledge" className="knowledge-section">
      <div className="container">
        <motion.div
          className="knowledge-header text-center"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.6 }}
        >
          <h2 className="section-title">Knowledge by ASTRA</h2>
          <p className="knowledge-subtitle">
            Practical technical skills and software mastery built to power the next generation of EV innovation.
          </p>
        </motion.div>
        ...
        <div className="knowledge-grid">
          ...
          >
            <h3 className="knowledge-card-title">SKILLS YOU’LL GAIN</h3>
          ...
          <motion.div
            className="knowledge-card knowledge-software-card"
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.5, delay: 0.2 }}
          >
            <h3 className="knowledge-card-title">Softwares you’ll know</h3>
            <div className="software-grid">
              {software.map((item) => (
                <div key={item.name} className="software-chip">
                  <div className="software-logo">{item.logo}</div>
